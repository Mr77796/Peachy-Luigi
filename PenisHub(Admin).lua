...
local Window = Library.CreateLib("PenisHub Admin", "RJTheme3")

local Tab = Window:NewTab("bla")

local Section = Tab:NewSection("приколюхи")
...
Section:NewButton("Fling", "Fling", function()
...
Section:NewButton("Super Rings Parts", "SRP V6", function()
   --[[
...
Section:NewButton("Animations", "Animations Stealer", function()
